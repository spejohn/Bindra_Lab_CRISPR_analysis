...
Usage:
    python -m analysis_pipeline.convert_input_files /path/to/input_directory
    python -m analysis_pipeline.convert_input_files --file /path/to/specific/file.csv
"""
...
# Import directly from the analysis_pipeline package
